package cn.kurisu.hutaonote.widget
 ...
 */
class SlantedTextView(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    private fun getAccentColor(): Int {
        ...
        context.theme.resolveAttribute(R.color.common_accent_color, typedValue, true)
