package cn.kurisu.hutaonote.manager
...
import cn.kurisu.hutaonote.widget.SlantedTextView
...
class ActivityManager private constructor() : ActivityLifecycleCallbacks {
    ...
    override fun onActivityCreated(activity: Activity, savedInstanceState: Bundle?) {
        ...
        if (AppConfig.isDebug()) {
            val debugFlag = LayoutInflater.from(activity).inflate(R.layout.debug_flag, null, true)
            debugFlag.findViewById<SlantedTextView>(R.id.iv_flag_debug)?.let {
